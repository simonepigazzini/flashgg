...
#for num in `seq 2 14`;
#do
#	echo 'hadd reweighting_01_12_2018_node_'${num}'/output_GluGluToHHTo2B2G_reweighted_node_'${num}'_13TeV-madgraph.root reweighting_01_12_2018_node_'${num}'/*madgraph.root'
#	echo 
#done
...
#for num in `seq 2 13`;
#do
#	echo 'cp reweighting_01_12_2018_node_'${num}'/output_GluGluToHHTo2B2G_reweighted_node_'${num}'_13TeV-madgraph.root /shome/nchernya/HHbbgg_ETH_devel/root_files/ntuples_2016_20181203/'
#	echo 
#done
