...
fggRunJobs.py --load jsons/HHbbgg_MC_2016_80X_nodesOnly.json -d reweighting_01_12_2018_node_$1 Systematics/test/workspaceStd.py maxEvents=-1 doubleHTagsOnly=True doDoubleHTag=True doBJetRegression=True doubleHReweightTarget=$1 doDoubleHGenAnalysis=True doSystematics=False dumpWorkspace=False dumpTrees=True year='2016'  -H -P -n 500  --no-copy-proxy useAAA=1 doPdfWeights=False -q all.q 
